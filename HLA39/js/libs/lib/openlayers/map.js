    ...
    */    
    setLayerZIndex: function (layer, zIdx) {
        ...
        layer.setZIndex(
			...
			//PERLAMORDEDEUS NAO APAGUE                                                           
			return 5;//GAMBIARRA PARA QUE A IMG NAO DESAPARE�A APOS USAR O ZOOM 20 VEZES NO IE10 ��
					 //ERA UMA VEZ... UM NAVEGADOR MUITO LEGAL, CHAMADO INTERNET EXPLORER!
			// BY
			// Ivanildo de Castro
		}
    },
    ...
    addControlToMap: function (control, px) {
        ...
        if (div) {
            if(!control.outsideViewport) {
				if ( div.id.indexOf('PanZoomBar') != -1 ) {
